...
from id3_types import apic_picture_types, frame_types, id3_field_encodings

filename = "Section8/Someday.mp3"
...
def main() -> None:
    with open(filename, "rb") as mp3_file:
        ...
        while True:
            ...
            if frame_id not in frame_types:
            ...
            if frame_id.startswith(b"T"):  # a text field
                ...
                print(f"Picture type: {apic_picture_name} image")
                ...
                if mime_type.startswith("image/"):
                    ...
                    picture_filename = (
                        f"Section8/{base_filename}_{apic_picture_name}.{image_type}"
                    )
