...
read_filename = "Section8/OlympicMedals_2020.csv"
write_filename = "Section8/medals_dict.py"
with open(read_filename, encoding="utf-8", newline="") as data, open(
    write_filename, "w", encoding="utf-8"
) as output_file:
