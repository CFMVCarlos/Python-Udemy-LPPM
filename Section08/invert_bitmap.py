...
def main():
    # source_file = "Section8/bm_test.txt"
    source_file = "Section8/vintage-halloween-bat.bmp"

    inverted_file = f"Section8/inverted-{source_file.removeprefix('Section8/')}"
    ...
    with open(source_file, "rb") as bat:  # No encoding
        ...
        #! If the file is in big endian format, we need to use 'big' instead of 'little'
